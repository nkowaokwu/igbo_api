...
| :----- | :----- | :----- |
| **X-API-Key** _required_ | Secret API token | `X-API-Key=API_token` |

**Query Parameters**

| Name                   | Description                                                              | Example         |
| :--------------------- | :----------------------------------------------------------------------- | :-------------- |
| **keyword** _required_ | Keyword for querying words                                               | `keyword=ego`   |
...
[
  {
    definitions: ['the likeness of an action or being; manner; how; the way;'],
    word: 'ètù',
    ...
    relatedTerms: ['636464df6ec644341fb395e5'],
