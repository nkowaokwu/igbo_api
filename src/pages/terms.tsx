    ...
    <Box style={{ minHeight: '96vh' }} className="flex flex-col items-center py-12">
      <Box className="w-11/12 lg:w-6/12 flex flex-col justify-start py-3 lg:py-10">
        ...
        <Box className="privacy-container space-y-4">
          ...
          <UnorderedList>
            <ListItem>
              Welcome to the <a href={APP_URL}>Igbo API</a>{' '}
              (the &#39; <strong>Igbo</strong>&#39;) dictionary API. The Website that offers an Igbo-English
              dictionary API as (the &#39; <strong>Services</strong>
              &#39;).
            </ListItem>
            <ListItem>
          ...
          <UnorderedList>
            ...
            <ListItem>
              ...
              your responsibility to ensure that the Subscription you elect to purchase
            ...
            <ListItem>
              ...
              Services (the &#39; <strong>Account</strong>&#39;).
            </ListItem>
            <ListItem>
              As part of the registration process, or as part of your continued use
              of the Services, you may be required to provide personal information about
            ...
            <ListItem>
              ...
              registered member of the Website (&#39; <strong>Member</strong>&#39;) and
              agree to be bound by the Terms. As a Member, you will be granted immediate
              access to the Services from the time you have completed the registration
              process until the subscription period expires (the &#39;{' '}
              <strong>Subscription Period</strong>&#39;). And you will automatically
              subscribe to all newsletters and promotions and you will have the ability
          ...
          <UnorderedList>
            <ListItem>(a)you will use the Services only for purposes that are permitted by:</ListItem>
            <Box pl={8}>
            ...
            <ListItem>
              ...
              parties, is strictly prohibited. You agree to immediately notify Nkowa
              Okwu LLC. of any unauthorised use of your password or email address or any
          ...
          <UnorderedList>
            <ListItem>
              The Website, the Services, and all of the related products of Nkowa
              Okwu LLC. are subject to copyright. The material on the Website is
              protected by copyright under the laws and through international treaties.
            ...
            <Box pl={8}>
              <ListItem>
                business name, trading name, domain name, trademark, industrial design,
          ...
          <UnorderedList>
            <ListItem>
              ...
              representations, or conditions implied or imposed by law, including the US
            ...
            <Box pl={8}>
              <ListItem>
                all terms, guarantees, warranties, representations or conditions which
            ...
            <Box pl={8}>
              <ListItem>
                ...
                computer virus or other harmful components, loss of data, communication
                line failure, unlawful
              </ListItem>
              <Text>
                third party conduct, or theft, destruction, alteration, or unauthorised
                access to records;
              </Text>
              <ListItem>
                the accuracy, suitability, or currency of any information on the
                Website, the Services, or any of its Services related products (including
          ...
          <UnorderedList>
            ...
            <ListItem>
              ...
              under any theory of liability. This shall include, but is not limited to,
          ...
          <Box pl={6}>
            ...
            <Text>
              ...
              following clauses have been complied with (except where urgent
            ...
            <Text>
              ...
              &#39;) has arisen under the Terms, must give written notice to the other
            ...
            <UnorderedList>
              <ListItem>
                Within 28 days of the Notice endeavor in good faith to resolve the
              ...
              <ListItem>
                ...
                appointed by the President of the primary dispute resolution process or
                his or her nominee;
              </ListItem>
              <ListItem>
                The Parties are equally liable for the fees and reasonable expenses of
                a mediator and the cost of the venue of the mediation and without limiting
                the foregoing undertake to pay any amounts requested by the mediator as a
                pre-condition to the mediation commencing. The Parties must each pay their
            ...
            <Text>
              All communications concerning negotiations made by the Parties arising out
              of and in connection with this dispute resolution clause are confidential
              and to the extent possible, must be treated as &quot;without
              prejudice&quot; negotiations for the purpose of applicable laws of
              evidence.
            </Text>
            <Heading as="h3">
            ...
            <Text>
              If 3 months have elapsed after the start of a mediation of the Dispute and
          ...
          <Text>
            The Terms are governed by the laws of. Any dispute, controversy,
            ...
            interpreted, and construed by, under and pursuant to the laws of , without
          ...
          <Text>
            ...
            and reasonable and both parties have taken the opportunity to obtain
            independent legal advice and declare the Terms are not against public
            policy on the grounds of inequality or bargaining power or general grounds
